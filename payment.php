   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="hidden" name="amt" value="<?= $grand_total; ?>" value="">
         </div>
         <div class="inputBox">
      ...
      <input type="submit" name="order" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="Razor Pay">
